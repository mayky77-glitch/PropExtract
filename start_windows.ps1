...
$Probe = & $RuntimePython -B -S -c "import openpyxl,struct,sys; from openpyxl import Workbook; Workbook(); print(f'{sys.version_info.major}.{sys.version_info.minor}.{sys.version_info.micro}|{struct.calcsize(`"P`")*8}|openpyxl-{openpyxl.__version__}')" 2>$null
