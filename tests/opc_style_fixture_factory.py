...
def package(destination: Path, *, style_xml: bytes | None = None, styles_relationship: str | None = None, style_name: str = "xl/styles.xml", style_override: str | None = None, sheet_one: bytes | None = None, extra_members: tuple[tuple[str, bytes], ...] = ()) -> Path:
